...
class CompMDMGeneratedDataset(Dataset):
    ...
    def __init__(self, mode, name, model, diffusion, dataloader, mm_num_samples, mm_num_repeats, max_motion_length, num_samples_limit, scale=1.):
        ...
        with torch.no_grad():
            for i, (motion, model_kwargs) in tqdm(enumerate(dataloader)):
                ...
                # print(model_kwargs['y']['body_parts'])
