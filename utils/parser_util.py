...
def add_base_options(parser):
    ...
    group.add_argument("--seed", default=3407, type=int, help="For fixing random seed.")
    group.add_argument("--batch_size", default=64, type=int, help="Batch size during training.")
    group.add_argument("--mode", default='train', choices=['train', 'sample', 'eval'], type=str, help="mode to model")
...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_body", default=2.0, type=float, help="Important body parts.")
    group.add_argument("--lambda_general", default=1.0, type=float, help="Not Important body parts.")
...
def add_training_options(parser):
    ...
    group.add_argument("--weight_vip", default=0.5, type=float,
                       help="Transformer Encoder of vip")
    group.add_argument("--weight_not", default=0.5, type=float,
                       help="Transformer Encoder of not vip")
...
def add_generate_options(parser):
    ...
    group.add_argument("--weight_vip", default=0.6, type=float,
                       help="Transformer Encoder of vip")
    group.add_argument("--weight_not", default=0.4, type=float,
                       help="Transformer Encoder of not vip")
    # group.add_argument("--core_parts", default="['left upper limb', 'right upper limb', 'left lower limb', 'right lower limb', 'torso']", type=str,
    #                    help="Core body parts,[left upper limb, right upper limb, left lower limb, right lower limb, torso].")
